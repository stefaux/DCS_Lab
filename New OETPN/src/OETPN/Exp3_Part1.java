...
public class Exp3_Part1 {
	...
	public static PetriNet PN4()
	{
		...
		p34Send.Value = new TransferOperation("localhost", "1090", "p1");
		mpn.PlaceList.add(p34Send);
		...
		grdT31.Activations.add(new Activation(t31, "p31", TransitionOperation.Add, "constantVal1"));
		...
		Condition T33Ct1 = new Condition(t33, "p31", TransitionCondition.LessThan, "constantVal2");
	...
	public static void main(String[] args) {
		...
		// Adding a second guarding to T1
		...
		grd2T1.Activations.add(new Activation(t1, "P3", TransitionOperation.ActivateSubPetri, ""));
